	   ...
	   <div class="logo">
	     ...
	     <ul class="megamenu skyblue">
			...
			<li><a class="color4" href="womenswatch.jsp">womens</a>
				...
				<li class="active grid"><a class="color3" href="register.jsp">Register</a></li>
					
				<li class="active grid"><a class="color3" href="customer-login.jsp">login</a></li>
				<li class="active grid"><a class="color3" href="admin-login.jsp">Admin</a></li>
				<div class="clearfix"> </div>
			</ul>
			</div>
	        <div class="clearfix"> </div>
